...
for (var i = 0; i < 5; i++) {
    ...
    if(j==1) {
        ...
        top_one.innerHTML +='<div class="row first">'+res+'</div><div class="row first_row"><div class="col-sm-1 col-md-1 col-xs-1"><img  src="img/coin.png" class="img_first"></div><div class="col-sm-3 col-md-3 col-xs-4 first_rank">'+myObj.data[i].coins+'</div><div class="col-sm-1 col-md-1 col-xs-1"><img  src="img/level icon.png" class="img_first"></div><div class="col-sm-3 col-md-3 col-xs-4 first_rank" >;kasd</div></div>';
    }
    if (j == 2) {
